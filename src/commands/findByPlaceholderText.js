    ...
    module.exports.command = function (text, callback) {
        ...
        this.execute(function (text) {
            try {
                const elm = window.TestingLibraryDom.findByPlaceholderText(document.body, text);
            ...
            if (result.value.error) {
                ...
                callback.call(self, { selector: 'findByPlaceholderText', value: text, locatorStrategy: 'findByPlaceholderText' })
            }
