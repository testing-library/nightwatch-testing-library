    ...
    module.exports.command = function (text, callback) {
        ...
        this.execute(function (text) {
            try {
                const elm = window.TestingLibraryDom.findByDisplayValue(document.body, text);
            ...
            if (result.value.error) {
                ...
                callback.call(self, { selector: 'findByDisplayValue', value: text, locatorStrategy: 'findByDisplayValue' })
            }
