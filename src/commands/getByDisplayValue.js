    ...
    module.exports.command = function (text, callback) {
        ...
        this.execute(function (text) {
            try {
                const elm = window.TestingLibraryDom.getByDisplayValue(document.body, text);
            ...
            if (result.value.error) {
                ...
                callback.call(self, { selector: 'getByDisplayValue', value: text, locatorStrategy: 'getByDisplayValue' })
            }
