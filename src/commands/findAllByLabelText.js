    ...
    module.exports.command = function (text, callback) {
        ...
        this.execute(function (text) {
            try {
                const elm = window.TestingLibraryDom.findAllByLabelText(document.body, text);
            ...
            if (result.value.error) {
                ...
                callback.call(self, { selector: 'findAllByLabelText', value: text, locatorStrategy: 'findAllByLabelText' })
            }
