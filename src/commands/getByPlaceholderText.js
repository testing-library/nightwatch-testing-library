    ...
    module.exports.command = function (text, callback) {
        ...
        this.execute(function (text) {
            try {
                const elm = window.TestingLibraryDom.getByPlaceholderText(document.body, text);
            ...
            if (result.value.error) {
                ...
                callback.call(self, { selector: 'getByPlaceholderText', value: text, locatorStrategy: 'getByPlaceholderText' })
            }
