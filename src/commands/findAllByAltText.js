    ...
    module.exports.command = function (text, callback) {
        ...
        this.execute(function (text) {
            try {
                const elm = window.TestingLibraryDom.findAllByAltText(document.body, text);
            ...
            if (result.value.error) {
                ...
                callback.call(self, { selector: 'findAllByAltText', value: text, locatorStrategy: 'findAllByAltText' })
            }
