    ...
    module.exports.command = function (text, callback) {
        ...
        this.execute(function (text) {
            try {
                const elm = window.TestingLibraryDom.getAllByDisplayValue(document.body, text);
            ...
            if (result.value.error) {
                ...
                callback.call(self, { selector: 'getAllByDisplayValue', value: text, locatorStrategy: 'getAllByDisplayValue' })
            }
