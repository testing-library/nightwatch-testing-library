    ...
    module.exports.command = function (text, callback) {
        ...
        this.execute(function (text) {
            try {
                const elm = window.TestingLibraryDom.queryByDisplayValue(document.body, text);
            ...
            if (result.value.error) {
                ...
                callback.call(self, { selector: 'queryByDisplayValue', value: text, locatorStrategy: 'queryByDisplayValue' })
            }
