    ...
    module.exports.command = function (text, callback) {
        ...
        this.execute(function (text) {
            try {
                const elm = window.TestingLibraryDom.queryByAltText(document.body, text);
            ...
            if (result.value.error) {
                ...
                callback.call(self, { selector: 'queryByAltText', value: text, locatorStrategy: 'queryByAltText' })
            }
