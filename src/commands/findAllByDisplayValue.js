    ...
    module.exports.command = function (text, callback) {
        ...
        this.execute(function (text) {
            try {
                const elm = window.TestingLibraryDom.findAllByDisplayValue(document.body, text);
            ...
            if (result.value.error) {
                ...
                callback.call(self, { selector: 'findAllByDisplayValue', value: text, locatorStrategy: 'findAllByDisplayValue' })
            }
