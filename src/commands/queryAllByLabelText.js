    ...
    module.exports.command = function (text, callback) {
        ...
        this.execute(function (text) {
            try {
                const elm = window.TestingLibraryDom.queryAllByLabelText(document.body, text);
            ...
            if (result.value.error) {
                ...
                callback.call(self, { selector: 'queryAllByLabelText', value: text, locatorStrategy: 'queryAllByLabelText' })
            }
