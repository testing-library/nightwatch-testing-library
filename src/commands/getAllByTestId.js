    ...
    module.exports.command = function (text, callback) {
        ...
        this.execute(function (text) {
            try {
                const elm = window.TestingLibraryDom.getAllByTestId(document.body, text);
            ...
            if (result.value.error) {
                ...
                callback.call(self, { selector: 'getAllByTestId', value: text, locatorStrategy: 'getAllByTestId' })
            }
