    ...
    module.exports.command = function (text, callback) {
        ...
        this.execute(function (text) {
            try {
                const elm = window.TestingLibraryDom.queryAllByPlaceholderText(document.body, text);
            ...
            if (result.value.error) {
                ...
                callback.call(self, { selector: 'queryAllByPlaceholderText', value: text, locatorStrategy: 'queryAllByPlaceholderText' })
            }
