    ...
    module.exports.command = function (text, callback) {
        ...
        this.execute(function (text) {
            try {
                const elm = window.TestingLibraryDom.queryAllByText(document.body, text);
            ...
            if (result.value.error) {
                ...
                callback.call(self, { selector: 'queryAllByText', value: text, locatorStrategy: 'queryAllByText' })
            }
