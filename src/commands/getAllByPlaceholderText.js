    ...
    module.exports.command = function (text, callback) {
        ...
        this.execute(function (text) {
            try {
                const elm = window.TestingLibraryDom.getAllByPlaceholderText(document.body, text);
            ...
            if (result.value.error) {
                ...
                callback.call(self, { selector: 'getAllByPlaceholderText', value: text, locatorStrategy: 'getAllByPlaceholderText' })
            }
